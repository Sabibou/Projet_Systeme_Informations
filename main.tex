...
typeSalle &	Type de salle &	A &	E & & Labo, machine, sport, classique		\\ 
      ...
      \begin{enumerate}
          \item numEleve->nomEleve  
\item	numEleve->prénomEleve   
\item numEleve	->demiGroupe   

\item numSalle->capacité    
\item	numSalle->typeSalle   

\item emailParent->numTelParent   
\item	   emailParent->sexeParent    
\item	   emailParent->nomParent	   \item emailParent->typeContactPref   

\item idAbsence->numEleve    
\item	 idAbsence->debutAbsence   
\item	 idAbsence->finAbsence    

\item numMatSalle->numSalle   
	\item   numMatSalle->nomMatériel 

\item numMatPrêtable->nomMatériel

\item demiGroupe->numClasse   

\item idSeance->numEnseignant   
\item	idSeance->numSalle    
\item	idSeance->matiere    
\item	idSeance->idCreneau   
\item	idSeance->typeCours    

\item idSeanceExcep->idSeance   
\item	     idSeanceExcep->dateReport   
\item	     idSeanceExcep->raisonReport   
\item	     idSeanceExcep->dateOrigine    

\item idCreneau->jourCreneau   
\item	 idCreneau->heureCreneau   
\item	 idCreneau->semaine    
      \end{enumerate}
    ...
    \begin{tabular}{p{4cm}|p{5cm}|p{5cm}}
        ...
        & 1, 2, 4, 5, 6, 7, 8, 9, 11, 12, 17, 19, 21, 23, 24, 25, 26, 27, 28 \\
         \hline
        Non & & \\
    ...
    \begin{figure}[H]
	      \centering
	      \includegraphics{./ebauche_mcd.jpg}
    ...
    \begin{figure}[H]
	      \centering
	      \includegraphics{./ebauche_mld.jpg}
    ...
    \begin{figure}[H]
	      \centering
	      \includegraphics{./mcd_amenage.jpg}
	      \caption{MCD aménagé}
	  ...
	  \begin{figure}[H]
	      \centering
	      \includegraphics{./mld_amenage.jpg}
